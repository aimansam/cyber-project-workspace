...
Use this board to keep red-team, blue-team, and lab work moving together.

## Backlog

| ID | Track | Task | Status | Notes |
| --- | --- | --- | --- | --- |
...
| IMG-001 | Images | Upload first project image and update inventory | Backlog | Add it under `assets/images/` and list it in `assets/images/README.md`. |
...
| ID | Completed Date | Result |
| --- | --- | --- |

## Weekly Review Questions

- What changed in scope or authorization?
- Which findings need defensive validation?
- Which detections need tuning?
- Which evidence needs redaction before sharing?
- Which lab snapshots or configs need backup?
- Which blog drafts or images are ready to publish?
